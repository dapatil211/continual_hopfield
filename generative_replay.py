...
class WGAN(nn.Module):
    def __init__(self, z_size,
                 ...
                 critic_channel_size, generator_channel_size):
        # configurations
        super().__init__()
        self.z_size = z_size
        self.image_size = image_size
        self.image_channel_size = image_channel_size
        self.critic_channel_size = critic_channel_size
        self.generator_channel_size = generator_channel_size

        # components
        self.critic = gan_models.Critic(
            image_size=self.image_size,
            image_channel_size=self.image_channel_size,
            channel_size=self.critic_channel_size,
        )
        self.generator = gan_models.Generator(
            z_size=self.z_size,
            image_size=self.image_size,
            image_channel_size=self.image_channel_size,
            channel_size=self.generator_channel_size,
        )
